...
class v400_m1_update_data extends \phpbb\db\migration\migration
{
	...
	public function update_data()
	{
		return [
			...
			['config.remove', ['ppde_ipn_balance']],
			['config.remove', ['ppde_ipn_enable']],
			['config.remove', ['ppde_ipn_logging']],
			['config.remove', ['ppde_sandbox_address']],
