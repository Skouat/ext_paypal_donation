...
class listener implements EventSubscriberInterface
{
	...
	{
		return $this->ppde_controller_main->ppde_auth->can_use_ppde() && $this->config['ppde_enable'] && $this->config['ppde_header_link'];
	}
	...
	{
		return $this->ppde_controller_main->ppde_auth->can_view_ppde_donorlist() && $this->ppde_controller_main->use_ipn() && $this->config['ppde_ipn_donorlist_enable'];
	}
